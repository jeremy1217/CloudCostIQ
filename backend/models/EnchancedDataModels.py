...
# This would be an addition to the existing EnhancedAnomalyDetection class in enhanced_anomaly.py
...
# Example of how to use this with the enhanced_anomaly.py:
# 
# In the EnhancedAnomalyDetection class:
# 
...
#     )
# 
# Then update the detect_anomalies method:
# 
# def detect_anomalies(self, cost_data, method="ensemble", threshold=None, analyze_root_cause=True, analyze_cloud_context=True):
#     """Detect anomalies in cloud costs and optionally analyze root causes and cloud context."""
#     # First perform regular anomaly detection
#     results = super().detect_anomalies(cost_data, method, threshold, analyze_root_cause)
#     
#     # If requested, add cloud context analysis
#     if analyze_cloud_context and results["anomalies"]:
#         cloud_context_results = self.cloud_context_detector.detect_cloud_context_anomalies(
#             cost_data=cost_data,
#             # Pass the anomalies we already detected
#             anomalies=results["anomalies"]
#         )
#         
#         # Update the anomalies with cloud context information
#         results["anomalies"] = cloud_context_results["anomalies"]
